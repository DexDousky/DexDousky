...
- 🎵 **Compositor VGM** | 🛠️ Modder | 💻 Programador | 🎨 Artista  
- 👥 Fundador da **Chaotix Crew'** e **Dousky Team**
...
![Haxe](https://img.shields.io/badge/HaxeFlixel-FF7700?style=flat&logo=haxe&logoColor=white)
...
- [**Queimada Crash**](https://github.com/DexDousky/APS-jogo-das-queimadas) – Jogo desenvolvido para APS.
- [**Python Encrypt Messenger**](https://github.com/DexDousky/python_rip.pynthao) – Mensageiro com criptografia em Python.

### Mods para Friday Night Funkin' (2021–2024)

- [**Dousky Collection**](https://gamebanana.com/mods/422331) – Compilado de minhas criações.
- [**Versus Dex Dousky v1 e v2**](https://gamebanana.com/mods/468489) – Mods focados no meu personagem.

### Colaborações em mods
